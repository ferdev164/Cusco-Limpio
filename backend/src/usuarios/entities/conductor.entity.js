...
var Conductor = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('conductores')];
    ...
    var _licencia_decorators;
    var _licencia_initializers = [];
    var _licencia_extraInitializers = [];
    var _turno_decorators;
    var _turno_initializers = [];
    var _turno_extraInitializers = [];
    var Conductor = _classThis = /** @class */ (function () {
        function Conductor_1() {
            this.id = __runInitializers(this, _id_initializers, void 0);
            this.usuario = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _usuario_initializers, void 0));
            this.licencia = (__runInitializers(this, _usuario_extraInitializers), __runInitializers(this, _licencia_initializers, void 0));
            this.turno = (__runInitializers(this, _licencia_extraInitializers), __runInitializers(this, _turno_initializers, void 0));
            __runInitializers(this, _turno_extraInitializers);
        }
        return Conductor_1;
    }());
    __setFunctionName(_classThis, "Conductor");
    (function () {
        ...
        _licencia_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _turno_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        ...
        __esDecorate(null, null, _licencia_decorators, { kind: "field", name: "licencia", static: false, private: false, access: { has: function (obj) { return "licencia" in obj; }, get: function (obj) { return obj.licencia; }, set: function (obj, value) { obj.licencia = value; } }, metadata: _metadata }, _licencia_initializers, _licencia_extraInitializers);
        ...
        Conductor = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Conductor = _classThis;
}();
